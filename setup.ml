...
(* OASIS_START *)
(* DO NOT EDIT (digest: c6596de63a2610574227cc5c4bb166f4) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("./test.byte", []))];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\000x\246\1482\218 \019\144@\170\251\2215\191V";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
